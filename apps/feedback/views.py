...
from apps.feedback.mixins import LikeDislikeMixin, FavoriteMixin, RatingMixin
from apps.feedback.models import FavoriteFilm, Rating, Like
from apps.feedback.permissions import IsFavoriteOwner
from apps.feedback.serializers import FavoriteSerializer, RatingSerializer, LikeSerializer
